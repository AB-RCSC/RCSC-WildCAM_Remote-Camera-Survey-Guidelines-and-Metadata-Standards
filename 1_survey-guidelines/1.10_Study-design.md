...
[Project](#project) or [survey](#Hierarch_Survey)-level aspects of design that camera users should consider (at a minimum) are:
...
The [objectives](#Survey_objectives) of the [survey](#Hierarch_Survey) will determine the most appropriate study design ([Appendix A - Table A2](#survey-guidelines-appendix-a-tables-a2)). There are five commonly used study designs in camera studies: [simple random](#Sampledesign_random), [systematic
...
:align: center
:name: #survey-guidelines-figure-3
...
design](#Sampledesign_random) ([Appendix A - Table A2](#survey-guidelines-appendix-a-tables-a2)).
...
**Systematic non-random** design -- sets of [clustered](#sampledesign_clustered) cameras can be deployed within a [systematic non-random](#SampleDesign_Systematic_NonRandom) approach (i.e,. "systematic clustered" or "systematic paired") to assess the effects of disturbance along a gradient, over
...
Refer to [Appendix A - Table A2](#survey-guidelines-appendix-a-tables-a2) for additional recommendations on [camera spacing](#Camera_spacing) for the different [modelling approaches](#Mods_Modelling_approach).
...
The [**total number of camera days**](#Total_number_of_camera_days) is the number of days that all cameras were active during the [survey](#Hierarch_Survey). [Appendix A - Table A2](#survey-guidelines-appendix-a-tables-a2) provides recommendations on the minimum number of [total number of camera
